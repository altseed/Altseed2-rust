...
// !!  YOUR COMMIT ON THIS FILE WILL BE WIPED. !!
// !!                                          !!
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
extern {
    ...
    fn cbg_Core_Initialize(title : *const u16, width : c_int, height : c_int, config : *mut RawPtr) -> bool;
    ...
    fn cbg_VertexArray_SetAt(self_ptr : *mut RawPtr, index : c_int, value : crate::structs::Vertex) -> ();
    ...
    fn cbg_Joystick_GetButtonStateByIndex(self_ptr : *mut RawPtr, joystickIndex : c_int, buttonIndex : c_int) -> c_int;
    
    fn cbg_Joystick_GetButtonStateByType(self_ptr : *mut RawPtr, joystickIndex : c_int, type_ : c_int) -> c_int;
    
    fn cbg_Joystick_GetJoystickType(self_ptr : *mut RawPtr, index : c_int) -> c_int;
    
    fn cbg_Joystick_GetAxisStateByIndex(self_ptr : *mut RawPtr, joystickIndex : c_int, axisIndex : c_int) -> c_float;
    
    fn cbg_Joystick_GetAxisStateByType(self_ptr : *mut RawPtr, joystickIndex : c_int, type_ : c_int) -> c_float;
    ...
    fn cbg_Material_GetVector4F(self_ptr : *mut RawPtr, key : *const u16) -> crate::structs::Vector4F;
    
    fn cbg_Material_SetVector4F(self_ptr : *mut RawPtr, key : *const u16, value : crate::structs::Vector4F) -> ();
    
    fn cbg_Material_GetMatrix44F(self_ptr : *mut RawPtr, key : *const u16) -> crate::structs::Matrix44F;
    
    fn cbg_Material_SetMatrix44F(self_ptr : *mut RawPtr, key : *const u16, value : crate::structs::Matrix44F) -> ();
    ...
    fn cbg_Renderer_DrawPolygon(self_ptr : *mut RawPtr, vertexBuffer : *mut RawPtr, indexBuffer : *mut RawPtr, texture : *mut RawPtr, material : *mut RawPtr) -> ();
    ...
    fn cbg_RenderedSprite_SetTransform(self_ptr : *mut RawPtr, value : crate::structs::Matrix44F) -> ();
    ...
    fn cbg_Font_CalcTextureSize(self_ptr : *mut RawPtr, text : *const u16, direction : c_int, isEnableKerning : bool) -> crate::structs::Vector2I;
    ...
    fn cbg_Tool_TextColored(self_ptr : *mut RawPtr, color : crate::structs::Vector4F, text : *const u16) -> ();
    ...
    fn cbg_Tool_Button(self_ptr : *mut RawPtr, label : *const u16, size : crate::structs::Vector2F) -> bool;
    ...
    fn cbg_Tool_InvisibleButton(self_ptr : *mut RawPtr, label : *const u16, size : crate::structs::Vector2F) -> bool;
    
    fn cbg_Tool_Selectable(self_ptr : *mut RawPtr, label : *const u16, selected : *const bool, flags : c_int) -> bool;
    
    fn cbg_Tool_InputInt(self_ptr : *mut RawPtr, label : *const u16, value : *const c_int) -> bool;
    
    fn cbg_Tool_InputFloat(self_ptr : *mut RawPtr, label : *const u16, value : *const c_float) -> bool;
    
    fn cbg_Tool_SliderInt(self_ptr : *mut RawPtr, label : *const u16, value : *const c_int, speed : c_float, valueMin : c_int, valueMax : c_int) -> bool;
    
    fn cbg_Tool_SliderFloat(self_ptr : *mut RawPtr, label : *const u16, value : *const c_float, speed : c_float, valueMin : c_float, valueMax : c_float) -> bool;
    
    fn cbg_Tool_SliderAngle(self_ptr : *mut RawPtr, label : *const u16, angle : *const c_float) -> bool;
    
    fn cbg_Tool_VSliderInt(self_ptr : *mut RawPtr, label : *const u16, size : crate::structs::Vector2F, value : *const c_int, valueMin : c_int, valueMax : c_int) -> bool;
    
    fn cbg_Tool_VSliderFloat(self_ptr : *mut RawPtr, label : *const u16, size : crate::structs::Vector2F, value : *const c_float, valueMin : c_float, valueMax : c_float) -> bool;
    
    fn cbg_Tool_DragInt(self_ptr : *mut RawPtr, label : *const u16, value : *const c_int, speed : c_float, valueMin : c_int, valueMax : c_int) -> bool;
    
    fn cbg_Tool_DragFloat(self_ptr : *mut RawPtr, label : *const u16, value : *const c_float, speed : c_float, valueMin : c_float, valueMax : c_float) -> bool;
    ...
    fn cbg_Tool_BeginChild(self_ptr : *mut RawPtr, label : *const u16, size : crate::structs::Vector2F, border : bool, flags : c_int) -> bool;
    ...
    fn cbg_Tool_MenuItem(self_ptr : *mut RawPtr, label : *const u16, shortcut : *const u16, selected : bool, enabled : bool) -> bool;
    ...
    fn cbg_Tool_GetMouseDragDelta(self_ptr : *mut RawPtr, button : c_int) -> crate::structs::Vector2F;
    
    fn cbg_Tool_ResetMouseDragDelta(self_ptr : *mut RawPtr, button : c_int) -> ();
    
    fn cbg_Tool_SetNextWindowContentSize(self_ptr : *mut RawPtr, size : crate::structs::Vector2F) -> ();
    ...
    fn cbg_File_AddRootPackageWithPassword(self_ptr : *mut RawPtr, path : *const u16, password : *const u16) -> bool;
    ...
    fn cbg_File_PackWithPassword(self_ptr : *mut RawPtr, srcPath : *const u16, dstPath : *const u16, password : *const u16) -> bool;
    ...
    fn cbg_SoundMixer_Fade(self_ptr : *mut RawPtr, id : c_int, second : c_float, targetedVolume : c_float) -> ();
    
    fn cbg_SoundMixer_GetIsPlaybackSpeedEnabled(self_ptr : *mut RawPtr, id : c_int) -> bool;
    
    fn cbg_SoundMixer_SetIsPlaybackSpeedEnabled(self_ptr : *mut RawPtr, id : c_int, isPlaybackSpeedEnabled : bool) -> ();
    
    fn cbg_SoundMixer_GetPlaybackSpeed(self_ptr : *mut RawPtr, id : c_int) -> c_float;
    
    fn cbg_SoundMixer_SetPlaybackSpeed(self_ptr : *mut RawPtr, id : c_int, playbackSpeed : c_float) -> ();
    
    fn cbg_SoundMixer_GetPanningPosition(self_ptr : *mut RawPtr, id : c_int) -> c_float;
    
    fn cbg_SoundMixer_SetPanningPosition(self_ptr : *mut RawPtr, id : c_int, panningPosition : c_float) -> ();
    
    fn cbg_SoundMixer_GetPlaybackPosition(self_ptr : *mut RawPtr, id : c_int) -> c_float;
    
    fn cbg_SoundMixer_SetPlaybackPosition(self_ptr : *mut RawPtr, id : c_int, position : c_float) -> ();
    
    fn cbg_SoundMixer_GetSpectrumData(self_ptr : *mut RawPtr, id : c_int, spectrums : *mut RawPtr, window : c_int) -> ();
    
    fn cbg_SoundMixer_Release(self_ptr : *mut RawPtr) -> ();
    
    fn cbg_Log_GetInstance() -> *mut RawPtr;
    
    fn cbg_Log_Write(self_ptr : *mut RawPtr, category : c_int, level : c_int, message : *const u16) -> ();
...
impl Core {
    ...
    pub fn initialize(title : &str, width : i32, height : i32, config : &mut Configuration) -> bool {
        let ret = unsafe { cbg_Core_Initialize(encode_string(&title).as_ptr(), width, height, config.self_ptr) };
        ret
    }
    ...
    /// 現在のFPSを取得します。
    pub fn get_current_f_p_s(&mut self) -> f32 {
    ...
    pub fn set_target_f_p_s(&mut self, value : f32) {
        self.target_f_p_s = Some(value.clone());
...
impl Mouse {
    ...
    pub fn set_position(&mut self, value : crate::math::Vector2<f32>) {
...
impl Joystick {
    ...
    pub fn get_button_state_by_index(&mut self, joystick_index : i32, button_index : i32) -> ButtonState {
        let ret = unsafe { cbg_Joystick_GetButtonStateByIndex(self.self_ptr, joystick_index, button_index) };
        unsafe { std::mem::transmute(ret) }
    }
    ...
    /// * `joystick_index` - 検索するジョイスティックのインデックス
    /// * `type_` - 状態を検索するボタンの種類
    pub fn get_button_state_by_type(&mut self, joystick_index : i32, type_ : JoystickButtonType) -> ButtonState {
        let ret = unsafe { cbg_Joystick_GetButtonStateByType(self.self_ptr, joystick_index, type_ as i32) };
        unsafe { std::mem::transmute(ret) }
    }
    ...
    pub fn get_axis_state_by_index(&mut self, joystick_index : i32, axis_index : i32) -> f32 {
        let ret = unsafe { cbg_Joystick_GetAxisStateByIndex(self.self_ptr, joystick_index, axis_index) };
        ret
    }
    ...
    pub fn get_axis_state_by_type(&mut self, joystick_index : i32, type_ : JoystickAxisType) -> f32 {
        let ret = unsafe { cbg_Joystick_GetAxisStateByType(self.self_ptr, joystick_index, type_ as i32) };
        ret
    }
...
impl Material {
    ...
    /// # Arguments
    /// * `key` - 
    pub fn get_vector4_f(&mut self, key : &str) -> crate::math::Vector4<f32> {
    ...
    /// * `key` - 
    /// * `value` - 
    pub fn set_vector4_f(&mut self, key : &str, value : crate::math::Vector4<f32>) -> () {
        unsafe { cbg_Material_SetVector4F(self.self_ptr, encode_string(&key).as_ptr(), value.into()) }
    }
    
    /// 
    /// # Arguments
    /// * `key` - 
    pub fn get_matrix44_f(&mut self, key : &str) -> crate::math::Matrix44<f32> {
    ...
    /// * `key` - 
    /// * `value` - 
    pub fn set_matrix44_f(&mut self, key : &str, value : crate::math::Matrix44<f32>) -> () {
        unsafe { cbg_Material_SetMatrix44F(self.self_ptr, encode_string(&key).as_ptr(), value.into()) }
    }
    ...
    pub fn set_texture(&mut self, key : &str, value : &mut Texture2D) -> () {
        unsafe { cbg_Material_SetTexture(self.self_ptr, encode_string(&key).as_ptr(), value.self_ptr) }
    }
...
impl Renderer {
    ...
    /// * `texture` - テクスチャ
    /// * `material` - マテリアル
    pub fn draw_polygon(&mut self, vertex_buffer : &mut VertexArray, index_buffer : &mut Int32Array, texture : &mut Texture2D, material : &mut Material) -> () {
        unsafe { cbg_Renderer_DrawPolygon(self.self_ptr, vertex_buffer.self_ptr, index_buffer.self_ptr, texture.self_ptr, material.self_ptr) }
    }
...
impl RenderedSprite {
    ...
    pub fn set_transform(&mut self, value : crate::math::Matrix44<f32>) {
...
impl RenderedText {
    ...
    pub fn set_font(&mut self, value : Arc<Mutex<Font>>) {
        ...
        unsafe { cbg_RenderedText_SetFont(self.self_ptr, value.lock().expect("Failed to get lock of Font").self_ptr) }
    }
...
impl Font {
    ...
    pub fn calc_texture_size(&mut self, text : &str, direction : WritingDirection, is_enable_kerning : bool) -> crate::math::Vector2<i32> {
        let ret = unsafe { cbg_Font_CalcTextureSize(self.self_ptr, encode_string(&text).as_ptr(), direction as i32, is_enable_kerning) };
        ret.into()
    }
    ...
    /// * `character` - 文字
    /// * `texture` - テクスチャ
    pub fn add_image_glyph(&mut self, character : i32, texture : &mut Texture2D) -> () {
...
impl Tool {
    ...
    pub fn begin(&mut self, name : &str, flags : ToolWindow) -> bool {
        let ret = unsafe { cbg_Tool_Begin(self.self_ptr, encode_string(&name).as_ptr(), flags as i32) };
        ret
    }
    ...
    /// 
    /// # Arguments
    pub fn dummy(&mut self, size : crate::math::Vector2<f32>) -> () {
    ...
    /// 
    /// # Arguments
    pub fn text_colored(&mut self, color : crate::math::Vector4<f32>, text : &str) -> () {
    ...
    pub fn label_text(&mut self, label : &str, text : &str) -> () {
        unsafe { cbg_Tool_LabelText(self.self_ptr, encode_string(&label).as_ptr(), encode_string(&text).as_ptr()) }
    }
    
    /// 
    /// # Arguments
    pub fn collapsing_header(&mut self, label : &str, flags : ToolTreeNode) -> bool {
        let ret = unsafe { cbg_Tool_CollapsingHeader(self.self_ptr, encode_string(&label).as_ptr(), flags as i32) };
        ret
    }
    ...
    pub fn tree_node_ex(&mut self, label : &str, flags : ToolTreeNode) -> bool {
        let ret = unsafe { cbg_Tool_TreeNodeEx(self.self_ptr, encode_string(&label).as_ptr(), flags as i32) };
        ret
    }
    ...
    /// 
    /// # Arguments
    pub fn button(&mut self, label : &str, size : crate::math::Vector2<f32>) -> bool {
        let ret = unsafe { cbg_Tool_Button(self.self_ptr, encode_string(&label).as_ptr(), size.into()) };
        ret
    }
    ...
    pub fn check_box(&mut self, label : &str, is_open : &mut bool) -> bool {
        let ret = unsafe { cbg_Tool_CheckBox(self.self_ptr, encode_string(&label).as_ptr(), is_open as *mut bool) };
        ret
    }
    ...
    pub fn radio_button(&mut self, label : &str, active : bool) -> bool {
        let ret = unsafe { cbg_Tool_RadioButton(self.self_ptr, encode_string(&label).as_ptr(), active) };
        ret
    }
    ...
    pub fn arrow_button(&mut self, label : &str, dir : ToolDir) -> bool {
        let ret = unsafe { cbg_Tool_ArrowButton(self.self_ptr, encode_string(&label).as_ptr(), dir as i32) };
        ret
    }
    
    /// 
    /// # Arguments
    pub fn invisible_button(&mut self, label : &str, size : crate::math::Vector2<f32>) -> bool {
        let ret = unsafe { cbg_Tool_InvisibleButton(self.self_ptr, encode_string(&label).as_ptr(), size.into()) };
        ret
    }
    ...
    pub fn selectable(&mut self, label : &str, selected : &bool, flags : ToolSelectable) -> bool {
        let ret = unsafe { cbg_Tool_Selectable(self.self_ptr, encode_string(&label).as_ptr(), selected as *const bool, flags as i32) };
        ret
    }
    ...
    pub fn input_int(&mut self, label : &str, value : &i32) -> bool {
        let ret = unsafe { cbg_Tool_InputInt(self.self_ptr, encode_string(&label).as_ptr(), value as *const c_int) };
        ret
    }
    ...
    pub fn input_float(&mut self, label : &str, value : &f32) -> bool {
        let ret = unsafe { cbg_Tool_InputFloat(self.self_ptr, encode_string(&label).as_ptr(), value as *const c_float) };
        ret
    }
    
    /// 
    /// # Arguments
    pub fn slider_int(&mut self, label : &str, value : &i32, speed : f32, value_min : i32, value_max : i32) -> bool {
        let ret = unsafe { cbg_Tool_SliderInt(self.self_ptr, encode_string(&label).as_ptr(), value as *const c_int, speed, value_min, value_max) };
        ret
    }
    
    /// 
    /// # Arguments
    pub fn slider_float(&mut self, label : &str, value : &f32, speed : f32, value_min : f32, value_max : f32) -> bool {
        let ret = unsafe { cbg_Tool_SliderFloat(self.self_ptr, encode_string(&label).as_ptr(), value as *const c_float, speed, value_min, value_max) };
        ret
    }
    ...
    pub fn slider_angle(&mut self, label : &str, angle : &f32) -> bool {
        let ret = unsafe { cbg_Tool_SliderAngle(self.self_ptr, encode_string(&label).as_ptr(), angle as *const c_float) };
        ret
    }
    
    /// 
    /// # Arguments
    pub fn v_slider_int(&mut self, label : &str, size : crate::math::Vector2<f32>, value : &i32, value_min : i32, value_max : i32) -> bool {
        let ret = unsafe { cbg_Tool_VSliderInt(self.self_ptr, encode_string(&label).as_ptr(), size.into(), value as *const c_int, value_min, value_max) };
        ret
    }
    
    /// 
    /// # Arguments
    pub fn v_slider_float(&mut self, label : &str, size : crate::math::Vector2<f32>, value : &f32, value_min : f32, value_max : f32) -> bool {
        let ret = unsafe { cbg_Tool_VSliderFloat(self.self_ptr, encode_string(&label).as_ptr(), size.into(), value as *const c_float, value_min, value_max) };
        ret
    }
    
    /// 
    /// # Arguments
    pub fn drag_int(&mut self, label : &str, value : &i32, speed : f32, value_min : i32, value_max : i32) -> bool {
        let ret = unsafe { cbg_Tool_DragInt(self.self_ptr, encode_string(&label).as_ptr(), value as *const c_int, speed, value_min, value_max) };
        ret
    }
    
    /// 
    /// # Arguments
    pub fn drag_float(&mut self, label : &str, value : &f32, speed : f32, value_min : f32, value_max : f32) -> bool {
        let ret = unsafe { cbg_Tool_DragFloat(self.self_ptr, encode_string(&label).as_ptr(), value as *const c_float, speed, value_min, value_max) };
        ret
    }
    ...
    pub fn begin_popup_modal(&mut self, label : &str) -> bool {
        let ret = unsafe { cbg_Tool_BeginPopupModal(self.self_ptr, encode_string(&label).as_ptr()) };
        ret
    }
    ...
    /// `EndChild()` を呼び出してください
    /// # Arguments
    pub fn begin_child(&mut self, label : &str, size : crate::math::Vector2<f32>, border : bool, flags : ToolWindow) -> bool {
        let ret = unsafe { cbg_Tool_BeginChild(self.self_ptr, encode_string(&label).as_ptr(), size.into(), border, flags as i32) };
        ret
    }
    ...
    pub fn begin_menu(&mut self, label : &str, enabled : bool) -> bool {
        let ret = unsafe { cbg_Tool_BeginMenu(self.self_ptr, encode_string(&label).as_ptr(), enabled) };
        ret
    }
    ...
    pub fn menu_item(&mut self, label : &str, shortcut : &str, selected : bool, enabled : bool) -> bool {
        let ret = unsafe { cbg_Tool_MenuItem(self.self_ptr, encode_string(&label).as_ptr(), encode_string(&shortcut).as_ptr(), selected, enabled) };
        ret
    }
    ...
    pub fn begin_tab_bar(&mut self, label : &str, flags : ToolTabBar) -> bool {
        let ret = unsafe { cbg_Tool_BeginTabBar(self.self_ptr, encode_string(&label).as_ptr(), flags as i32) };
        ret
    }
    ...
    /// 
    /// # Arguments
    pub fn push_i_d(&mut self, id : i32) -> () {
        unsafe { cbg_Tool_PushID(self.self_ptr, id) }
    }
    
    /// 
    pub fn pop_i_d(&mut self) -> () {
    ...
    /// 
    /// # Arguments
    pub fn set_window_size(&mut self, size : crate::math::Vector2<f32>) -> () {
    ...
    /// 
    /// # Arguments
    pub fn set_next_window_content_size(&mut self, size : crate::math::Vector2<f32>) -> () {
        unsafe { cbg_Tool_SetNextWindowContentSize(self.self_ptr, size.into()) }
    }
    
    /// 
    /// # Arguments
    pub fn set_next_window_size(&mut self, size : crate::math::Vector2<f32>) -> () {
        unsafe { cbg_Tool_SetNextWindowSize(self.self_ptr, size.into()) }
    }
    
    /// 
    /// # Arguments
    pub fn set_next_window_pos(&mut self, pos : crate::math::Vector2<f32>) -> () {
...
impl File {
    ...
    pub fn add_root_directory(&mut self, path : &str) -> bool {
        let ret = unsafe { cbg_File_AddRootDirectory(self.self_ptr, encode_string(&path).as_ptr()) };
        ret
    }
    ...
    pub fn add_root_package_with_password(&mut self, path : &str, password : &str) -> bool {
        let ret = unsafe { cbg_File_AddRootPackageWithPassword(self.self_ptr, encode_string(&path).as_ptr(), encode_string(&password).as_ptr()) };
        ret
    }
    ...
    pub fn pack(&mut self, src_path : &str, dst_path : &str) -> bool {
        let ret = unsafe { cbg_File_Pack(self.self_ptr, encode_string(&src_path).as_ptr(), encode_string(&dst_path).as_ptr()) };
        ret
    }
    ...
    pub fn pack_with_password(&mut self, src_path : &str, dst_path : &str, password : &str) -> bool {
        let ret = unsafe { cbg_File_PackWithPassword(self.self_ptr, encode_string(&src_path).as_ptr(), encode_string(&dst_path).as_ptr(), encode_string(&password).as_ptr()) };
        ret
    }
...
impl SoundMixer {
    ...
    pub fn set_is_playback_speed_enabled(&mut self, id : i32, is_playback_speed_enabled : bool) -> () {
        unsafe { cbg_SoundMixer_SetIsPlaybackSpeedEnabled(self.self_ptr, id, is_playback_speed_enabled) }
    }
    ...
    pub(crate) fn get_spectrum_data(&mut self, id : i32, spectrums : &mut FloatArray, window : FFTWindow) -> () {
        unsafe { cbg_SoundMixer_GetSpectrumData(self.self_ptr, id, spectrums.self_ptr, window as i32) }
    }
...
impl Log {
    ...
    pub fn write(&mut self, category : LogCategory, level : LogLevel, message : &str) -> () {
        unsafe { cbg_Log_Write(self.self_ptr, category as i32, level as i32, encode_string(&message).as_ptr()) }
    }
    
    /// ログレベルTraceでログを出力します。
    /// # Arguments
    pub fn trace(&mut self, category : LogCategory, message : &str) -> () {
        unsafe { cbg_Log_Trace(self.self_ptr, category as i32, encode_string(&message).as_ptr()) }
    }
    
    /// ログレベルDebugでログを出力します。
    /// # Arguments
    pub fn debug(&mut self, category : LogCategory, message : &str) -> () {
        unsafe { cbg_Log_Debug(self.self_ptr, category as i32, encode_string(&message).as_ptr()) }
    }
    
    /// ログレベルInfoでログを出力します。
    /// # Arguments
    pub fn info(&mut self, category : LogCategory, message : &str) -> () {
        unsafe { cbg_Log_Info(self.self_ptr, category as i32, encode_string(&message).as_ptr()) }
    }
    
    /// ログレベルWarningでログを出力します。
    /// # Arguments
    pub fn warn(&mut self, category : LogCategory, message : &str) -> () {
        unsafe { cbg_Log_Warn(self.self_ptr, category as i32, encode_string(&message).as_ptr()) }
    }
    
    /// ログレベルErrorでログを出力します。
    /// # Arguments
    pub fn error(&mut self, category : LogCategory, message : &str) -> () {
        unsafe { cbg_Log_Error(self.self_ptr, category as i32, encode_string(&message).as_ptr()) }
    }
    
    /// ログレベルCriticalでログを出力します。
    /// # Arguments
    pub fn critical(&mut self, category : LogCategory, message : &str) -> () {
        unsafe { cbg_Log_Critical(self.self_ptr, category as i32, encode_string(&message).as_ptr()) }
    }
