...
extern {
    ...
    fn cbg_VertexArray_SetAt(self_ptr: *mut RawPtr, index: c_int, value: *mut crate::structs::Vertex) -> ();
    ...
    fn cbg_Vector2FArray_SetAt(self_ptr: *mut RawPtr, index: c_int, value: *mut crate::structs::Vector2F) -> ();
    ...
    fn cbg_Material_SetVector4F(self_ptr: *mut RawPtr, key: *const u16, value: *mut crate::structs::Vector4F) -> ();
    
    fn cbg_Material_GetMatrix44F(self_ptr: *mut RawPtr, key: *const u16) -> crate::structs::Matrix44F;
    
    fn cbg_Material_SetMatrix44F(self_ptr: *mut RawPtr, key: *const u16, value: *mut crate::structs::Matrix44F) -> ();
    ...
    fn cbg_Rendered_SetTransform(self_ptr: *mut RawPtr, value: *mut crate::structs::Matrix44F) -> ();
    ...
    fn cbg_RenderedSprite_SetTransform(self_ptr: *mut RawPtr, value: *mut crate::structs::Matrix44F) -> ();
    ...
    fn cbg_RenderedText_SetTransform(self_ptr: *mut RawPtr, value: *mut crate::structs::Matrix44F) -> ();
    ...
    fn cbg_RenderedPolygon_SetVertexesByVector2F(self_ptr: *mut RawPtr, vertexes: *mut RawPtr) -> ();
    ...
    fn cbg_RenderedPolygon_SetTransform(self_ptr: *mut RawPtr, value: *mut crate::structs::Matrix44F) -> ();
    ...
    fn cbg_Tool_TextColored(self_ptr: *mut RawPtr, color: *mut crate::structs::Vector4F, text: *const u16) -> ();
    ...
    fn cbg_Tool_Button(self_ptr: *mut RawPtr, label: *const u16, size: *mut crate::structs::Vector2F) -> bool;
    ...
    fn cbg_Tool_InvisibleButton(self_ptr: *mut RawPtr, label: *const u16, size: *mut crate::structs::Vector2F) -> bool;
    ...
    fn cbg_Tool_VSliderInt(self_ptr: *mut RawPtr, label: *const u16, size: *mut crate::structs::Vector2F, value: *const c_int, valueMin: c_int, valueMax: c_int) -> bool;
    
    fn cbg_Tool_VSliderFloat(self_ptr: *mut RawPtr, label: *const u16, size: *mut crate::structs::Vector2F, value: *const c_float, valueMin: c_float, valueMax: c_float) -> bool;
    ...
    fn cbg_Tool_BeginChild(self_ptr: *mut RawPtr, label: *const u16, size: *mut crate::structs::Vector2F, border: bool, flags: c_int) -> bool;
    ...
    fn cbg_Tool_SetNextWindowContentSize(self_ptr: *mut RawPtr, size: *mut crate::structs::Vector2F) -> ();
...
impl Core {
    ...
    pub fn get_target_fps(&mut self) -> f32 {
        if let Some(value) = self.target_fps.clone() { return value; }
...
impl Material {
    ...
    pub fn set_vector4f(&mut self, key : &str, mut value : crate::prelude::Vector4<f32>) -> () {
        unsafe { cbg_Material_SetVector4F(self.self_ptr, encode_string(&key).as_ptr(), &mut value.into() as *mut _) }
    }
    ...
    pub fn set_matrix44f(&mut self, key : &str, mut value : crate::prelude::Matrix44<f32>) -> () {
        unsafe { cbg_Material_SetMatrix44F(self.self_ptr, encode_string(&key).as_ptr(), &mut value.into() as *mut _) }
    }
...
impl Tool {
    ...
    pub fn begin(&mut self, name : &str, flags : ToolWindow) -> bool {
        let ret = unsafe { cbg_Tool_Begin(self.self_ptr, encode_string(&name).as_ptr(), flags.bits as i32) };
        ret
    }
    ...
    pub fn text_colored(&mut self, mut color : crate::prelude::Vector4<f32>, text : &str) -> () {
        unsafe { cbg_Tool_TextColored(self.self_ptr, &mut color.into() as *mut _, encode_string(&text).as_ptr()) }
    }
    ...
    pub fn collapsing_header(&mut self, label : &str, flags : ToolTreeNode) -> bool {
        let ret = unsafe { cbg_Tool_CollapsingHeader(self.self_ptr, encode_string(&label).as_ptr(), flags.bits as i32) };
        ret
    }
    ...
    pub fn tree_node_ex(&mut self, label : &str, flags : ToolTreeNode) -> bool {
        let ret = unsafe { cbg_Tool_TreeNodeEx(self.self_ptr, encode_string(&label).as_ptr(), flags.bits as i32) };
        ret
    }
    ...
    pub fn button(&mut self, label : &str, mut size : crate::prelude::Vector2<f32>) -> bool {
        let ret = unsafe { cbg_Tool_Button(self.self_ptr, encode_string(&label).as_ptr(), &mut size.into() as *mut _) };
        ret
    }
    ...
    pub fn invisible_button(&mut self, label : &str, mut size : crate::prelude::Vector2<f32>) -> bool {
        let ret = unsafe { cbg_Tool_InvisibleButton(self.self_ptr, encode_string(&label).as_ptr(), &mut size.into() as *mut _) };
        ret
    }
    ...
    pub fn selectable(&mut self, label : &str, selected : &bool, flags : ToolSelectable) -> bool {
        let ret = unsafe { cbg_Tool_Selectable(self.self_ptr, encode_string(&label).as_ptr(), selected as *const bool, flags.bits as i32) };
        ret
    }
    ...
    pub fn vslider_int(&mut self, label : &str, mut size : crate::prelude::Vector2<f32>, value : &i32, value_min : i32, value_max : i32) -> bool {
        let ret = unsafe { cbg_Tool_VSliderInt(self.self_ptr, encode_string(&label).as_ptr(), &mut size.into() as *mut _, value as *const c_int, value_min, value_max) };
        ret
    }
    
    /// 
    
    pub fn vslider_float(&mut self, label : &str, mut size : crate::prelude::Vector2<f32>, value : &f32, value_min : f32, value_max : f32) -> bool {
        let ret = unsafe { cbg_Tool_VSliderFloat(self.self_ptr, encode_string(&label).as_ptr(), &mut size.into() as *mut _, value as *const c_float, value_min, value_max) };
        ret
    }
    ...
    pub fn begin_child(&mut self, label : &str, mut size : crate::prelude::Vector2<f32>, border : bool, flags : ToolWindow) -> bool {
        let ret = unsafe { cbg_Tool_BeginChild(self.self_ptr, encode_string(&label).as_ptr(), &mut size.into() as *mut _, border, flags.bits as i32) };
        ret
    }
    ...
    pub fn begin_tab_bar(&mut self, label : &str, flags : ToolTabBar) -> bool {
        let ret = unsafe { cbg_Tool_BeginTabBar(self.self_ptr, encode_string(&label).as_ptr(), flags.bits as i32) };
        ret
    }
