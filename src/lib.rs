...
pub mod prelude {
    ...
    pub use crate::auto_generated_core_binding::{
        BuiltinShaderType, ButtonState, Configuration, CursorMode, File, Font, FramerateMode,
        Joystick, JoystickAxisType, JoystickButtonType, JoystickType, Keyboard, Keys, Log,
        LogCategory, LogLevel, Mouse, MouseButtons, Sound, SoundMixer, StaticFile, StreamFile,
